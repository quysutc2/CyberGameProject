...
void Payment :: processPayment() {
    isPaid = true;
    cout << "Payment complete for customer ID: " << customerId << std::endl;
}

// hien thi chi tiet thanh toan
void Payment :: displayPaymentDetails() const {
    cout << "Customer ID: " << customerId << std::endl;
    cout << "Usage time: " << usageTimeInMinutes << " minutes" << std::endl;
    cout << "Total amount: $" << totalAmount << std::endl;
    cout << "Payment status: " << (isPaid ? "Completed" : "Pending") << std::endl;
}
